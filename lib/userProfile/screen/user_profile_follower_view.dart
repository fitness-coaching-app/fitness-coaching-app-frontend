...
class UserProfileFollower extends StatefulWidget {
  const UserProfileFollower({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => UserProfileFollowerState();
}

class UserProfileFollowerState extends State<UserProfileFollower> {
  @override
