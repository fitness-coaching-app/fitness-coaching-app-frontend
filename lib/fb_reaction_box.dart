...
class FbReactionState extends State<FbReaction> with TickerProviderStateMixin {
              ...
              children: <Widget>[
                ...
                whichIconUserChoose == 1 && !isDragging
                    ? Container(
                        child: Transform.scale(
                          child: Image.asset(
                            'assets/reactions/images/like.gif',
                            width: 40.0,
                            height: 40.0,
                          ),
                ...
                whichIconUserChoose == 2 && !isDragging
                    ? Container(
                        child: Transform.scale(
                          child: Image.asset(
                            'assets/reactions/images/love.gif',
                            width: 40.0,
                            height: 40.0,
                          ),
                          scale: this.zoomIconWhenRelease.value,
                ...
                whichIconUserChoose == 3 && !isDragging
                    ? Container(
                        child: Transform.scale(
                          child: Image.asset(
                            'assets/reactions/images/haha.gif',
                            width: 40.0,
                            height: 40.0,
                          ),
                          scale: this.zoomIconWhenRelease.value,
                ...
                whichIconUserChoose == 4 && !isDragging
                    ? Container(
                        child: Transform.scale(
                          child: Image.asset(
                            'assets/reactions/images/wow.gif',
                            width: 40.0,
                            height: 40.0,
                          ),
                          scale: this.zoomIconWhenRelease.value,
                ...
                whichIconUserChoose == 5 && !isDragging
                    ? Container(
                        child: Transform.scale(
                          child: Image.asset(
                            'assets/reactions/images/sad.gif',
                            width: 40.0,
                            height: 40.0,
                          ),
                          scale: this.zoomIconWhenRelease.value,
                ...
                whichIconUserChoose == 6 && !isDragging
                    ? Container(
                        child: Transform.scale(
                          child: Image.asset(
                            'assets/reactions/images/angry.gif',
                            width: 40.0,
                            height: 40.0,
                          ),
                          scale: this.zoomIconWhenRelease.value,
  ...
  String getImageIconBtn() {
    if (!isLongPress && isLiked) {
      return 'assets/reactions/images/ic_like_fill.png';
    } else if (!isDragging) {
      switch (whichIconUserChoose) {
        case 1:
          return 'assets/reactions/images/ic_like_fill.png';
        case 2:
          return 'assets/reactions/images/love2.png';
        case 3:
          return 'assets/reactions/images/haha2.png';
        case 4:
          return 'assets/reactions/images/wow2.png';
        case 5:
          return 'assets/reactions/images/sad2.png';
        case 6:
          return 'assets/reactions/images/angry2.png';
        default:
          return 'assets/reactions/images/ic_like.png';
      }
    } else {
      return 'assets/reactions/images/ic_like.png';
    }
  ...
  Future loadAsset(String nameSound) async {
    return await rootBundle.load('assets/reactions/sounds/$nameSound');
  }
}
