...
class ThinButtonHighlight extends StatefulWidget {
  final String text;
  ...
  @override
  State<StatefulWidget> createState() => _ThinButtonHighlightState();
}

class _ThinButtonHighlightState extends State<ThinButtonHighlight> {
  @override
